 ...
 */
public class LeftNearLeftMidLeft extends Path {
    /**
    ...
    public LeftNearLeftMidLeft() {
        ...
        super(            
            ...
            new PathPoint(
                ...
                new Rotation2d(Math.toRadians(-Math.PI*(3)/4)),     // Rotation (rad) (may need to add rotation here depending on how fast our robot is spinning)
                1,    // Speed (m/s)
