...
public class FarRightHoover extends SequentialCommandGroup {
    public FarRightHoover() {
        super(
            new SetDrivePosition(
                Field.mirrorPointIfRed(
                    new Pose2d(Constants.Paths.START_FAR_RIGHT, Constants.Paths.START_CENTER_ANGLE)
                )
            ),
